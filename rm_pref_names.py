...
connector.put_client_data("1151100","/", ["clientBasicInfo","preferredName"], "Tone")
quit()
    ...
    try:
        ...
        if partner_dict != None :
            ...
            if p_fname == p_pname:
                ...
                connector.put_client_data(aDLID,"/", ["partner","preferredName"], None)
        ...
        if fname == pname:
            print("found one")
            connector.put_client_data(aDLID,"/", ["clientBasicInfo","preferredName"], None)
